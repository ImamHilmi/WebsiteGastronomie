...
class LRM_API_Manager_MENU {
	...
	public function wc_am_api_key_field() {
		...
		echo "<input id='api_key' name='" . LRM_API_Manager()->ame_data_key . "[" . LRM_API_Manager()->ame_api_key ."]' size='25' type='text' value='" . 'weaplay' . "' />";
	...
	public function validate_options( $input ) {
        ...
        $options[LRM_API_Manager()->ame_api_key] = 'weaplay';
		$options[LRM_API_Manager()->ame_activation_email] = 'nulled@weadown.com';
		$options['ame_activation_server_alternative'] = home_url();

		/**
		  * Plugin Activation
		  */
		$api_email = 'nulled@weadown.com';
		$api_key = 'weaplay';
